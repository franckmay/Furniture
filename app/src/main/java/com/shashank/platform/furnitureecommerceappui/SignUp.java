...
public class SignUp extends AppCompatActivity {
        ...
        public void OpenStartingPage(View view) {
            ...
            new Handler().postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    startActivity(new Intent(SignUp.this, ConnexionActivity.class).putExtra("email", user_email.getText().toString()));
                    finish();
                }
            }, 3000);
        }
        ...
        public void OpenConnexionPage(View view) {
            startActivity(new Intent(SignUp.this, ConnexionActivity.class));
            finish();
        }
